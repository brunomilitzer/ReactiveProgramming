package com.brunomilitzer.restbrewery.bootstrap;
...
public class BeerLoader implements CommandLineRunner {
    ...
    private synchronized void loadBeerObjects() {
        ...
        log.debug( "Loading initial data. Count is: {}", this.beerRepository.count().block() );

        if ( this.beerRepository.count().block() != null && this.beerRepository.count().block() == 0 ) {
            ...
            log.debug( "Beer Records loaded: {}", this.beerRepository.count().block() );
        }
    }
